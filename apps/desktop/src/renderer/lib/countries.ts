/** ISO 3166-1 countries (name + alpha-2) for the location country picker. */
...
/** Case-insensitive prefix-then-substring filter, alphabetical, capped. */
export function filterCountries(queryRaw: string, limit = 8): Country[] {
