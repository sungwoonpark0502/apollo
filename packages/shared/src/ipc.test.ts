...
const invokeFixtures: Record<InvokeChannelName, { req: unknown; res: unknown }> = {
  ...
  'conversations.list': { req: { limit: 50 }, res: [{ id: 'c1', title: 'set a timer', startedAt: 1, lastTs: 2, messageCount: 4 }] },
  'conversations.get': { req: { id: 'c1' }, res: { messages: [{ role: 'user', content: 'hi', ts: 1 }, { role: 'assistant', content: 'hello', ts: 2 }] } },
