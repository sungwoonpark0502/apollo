...
export const STRINGS = {
  ...
  settings: {
    ...
    customize: {
      ...
      skills: 'Skills',
      skillsBody: "Standing instructions Apollo follows in every conversation — how to talk, what language, what to always do. Apollo's safety rules still apply.",
      skillsEmpty: 'No skills yet. Try one like "Keep replies under two sentences."',
      skillAdd: 'Add a skill',
      skillName: 'Skill name',
      skillNamePlaceholder: 'Name (e.g. Terse mode)',
      skillPrompt: 'Instructions',
      skillPromptPlaceholder: 'What should Apollo always do?',
      skillSave: 'Save',
      skillCancel: 'Cancel',
    ...
    account: {
      ...
      signUpBody: 'Create an account to use the assistant. Your notes, calendar, and reminders stay on this device.',
      passwordHint: 'At least 10 characters. A few plain words beat one clever word.',
      errEmailInvalid: 'Enter a valid email address.',
      errPasswordRequired: 'Enter your password.',
      errPasswordShort: 'Use at least 10 characters.',
      errInvalidCredentials: 'That email and password do not match.',
      errEmailTaken: 'That email cannot be used. Try signing in instead.',
      errTooManyAttempts: 'Too many attempts. Try again in 15 minutes.',
      errNetwork: "Could not reach Apollo. Check your connection and try again.",
      errBusy: 'Already signing in.',
      errGeneric: 'Sign-in failed. Try again.',
      signOut: 'Sign out',
    ...
    calendars: {
      ...
      // Normally the reassign dialog handles this; copy exists so the fallback
      // path is never a blank or a raw code.
      hasEvents: 'That calendar still has events. Move them to another calendar first.',
      cannotDeleteDefault: 'The default calendar cannot be deleted.',
      notFound: 'That calendar no longer exists.',
      invalidReassign: 'Pick a different calendar to move those events to.',
    },
    proactive: {
    ...
    profile: {
      ...
      locationLookupFailed: "Couldn't reach the location service. Check your connection and try again.",
      h12: '12-hour',
      h24: '24-hour',
  ...
  workspace: {
    ...
    // L2: Today is exactly header + schedule + weather + news.
    today: {
      ...
      emptyWeather: 'Add your location to see the weather.',
      setLocation: 'Set your location',
      emptyNews: 'No headlines right now.',
      newEvent: 'New event',
    },
    calendar: {
      month: 'Month',
